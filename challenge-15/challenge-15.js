(function () {
    ...
    */
    ...
    var felipe = new Person('Felipe', 'Silva', 22);
    var maria = new Person('Maria', 'José', 42);
    var zé = new Person('Zé', 'Santos', 62);
    console.log(felipe)
    console.log(maria)
    console.log(zé)
    ...
    */
    ...
    console.log( zé.getFullName() + ' agora tem ' + zé.addAge(-22).getAge() + ' anos.')
